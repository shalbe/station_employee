...
class AcceptedWithDrawPage extends StatelessWidget {
  const AcceptedWithDrawPage({super.key});
            ...
            body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  cubit.acceptedWithDraw.isEmpty
                      ? Center(
                          child: defaultText(txt: 'لا يوجد طلبات مقبوله'),
                        )
                      : ListView.separated(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          itemBuilder: (context, index) => GetWithDraw(
                                data: cubit.acceptedWithDraw[index],
                              ),
                          separatorBuilder: (context, index) => SizedBox(
                                height: 15.h,
                              ),
                          itemCount: cubit.acceptedWithDraw.length),
                ],
              ),
            ),
          );
