...
class CarsDetailsSalesUpdate extends StatefulWidget {
  String? number;
  String? empName;
  int? amount;
  int? id;
  ...
  @override
  State<CarsDetailsSalesUpdate> createState() => _CarsDetailsSalesUpdateState();
}

class _CarsDetailsSalesUpdateState extends State<CarsDetailsSalesUpdate> {
                        ...
                        Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  cubit.carNumberDebitSellUpdate(
